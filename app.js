...
var dbStore = new MongoDBStore({
    uri: 'mongodb://localhost:27017/connect_mongodb_session_test', // replace with uri: 'mongodb+srv://${process.env.ATLAS_DB_USER}:${process.env.ATLAS_DB_PASSWORD}@cluster0.pkjtbxx.mongodb.net/comp2537w1?retryWrites=true&w=majority',
